...
public class KVCacheTest {
    ...
    public void testDelete() {
    	...
    	assertNull(cache.get("1"));
    	cache.put("1", "crazyboys");
    	cache.put("4", "cheatingmormons");
    	assertEquals("crazyboys", cache.get("1"));
    	assertEquals("cheatingmormons", cache.get("4"));
    }
    ...
    public void evictionTest() {
    	...
    	assertEquals("mudkip", cache.get("4"));
    	assertEquals("mudkip", cache.get("5"));
    	assertEquals("mudkip", cache.get("6"));
    	assertEquals("mudkip", cache.get("3"));
    	cache.put("7", "mudkip");
    	assertNull(cache.get("4"));
    	assertEquals("mudkip", cache.get("7"));
    }
